...
# ==========================================
# Isolated data directory for Friday's Snippet operations
...
def fetch_daily_intelligence():
    print("🌍 Scraping strategic RSS feeds for Friday's Snippet 2.0...")
    aggregated_news = ""
    total_articles = 0
...
if __name__ == "__main__":
    try:
        ...
        # Target the isolated Friday's Snippet data folder
