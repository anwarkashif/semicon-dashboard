    ...
    def execute(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # ==========================================
            ...
            2. MANDATORY TOPICAL CRITERIA: You MUST actively scan the intercepts and extract verifiable news covering the following high-priority intelligence vectors:
               - Geopolitics, geoeconomics, national security, defense, defense budget, conflict, war, aircraft carrier, warship, naval fleet, navy fleet, military exercise and operation, military action, threats, weaponry, arsenal, military assets, ballistic missile and attack, launch military weapons, security, defense cooperation, military cooperation, warships, hypersonic missile, long-range missile systems, rocket & weapon manufacturing.
               - Rare Earth elements, semiconductors, global supply chains, chips, chips tariff, and critical minerals.
               - Legislative & Government: US House, bills, acts, official/unofficial delegations and state head visit, embassy/embassies.
               - Financial & Economic: Global financial system, financial sanctions, sanction, asset seizure/sold, reimbursement, debt, NATO share, and damage costs.
               ...
               - Multilateral & Key States: US, Russia, China, P5, UNSC, UN General Assembly, recongnize, trade, trade deals, banning import, banning export, consulate news, opening and closing the consulate, communiqué or communique, Veto, India, EU, SAARC, ASEAN and ASEAN related news, Joint Statement, Illegal Israeli settlement, occupied forces, occupied, territories, national ban, NATO, CIA, MI6, Mossad, UN, BRICS, SCO, G20, African Union, AUKUS, GCC, and national intelligence agencies.
