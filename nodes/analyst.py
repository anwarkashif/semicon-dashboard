    ...
    def execute(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # ==========================================
            ...
            {{
              ...
              "Top_News": {{
                 "Global": ["Specific News 1", "Specific News 2", "Specific News 3", "Specific News 4", "Specific News 5", "Specific News 6", "Specific News 7", "Specific News 8", "Specific News 9", "Specific News 10", "Specific News 11", "Specific News 12", "Specific News 13", "Specific News 14", "Specific News 15"]
              }},
