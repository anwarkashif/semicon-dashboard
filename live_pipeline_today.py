...
# ==========================================
# Isolated data directory for Today's Snippet operations
...
def fetch_daily_intelligence():
    print("🌍 Scraping strategic RSS feeds for Today's Snippet...")
    aggregated_news = ""
    total_articles = 0
...
if __name__ == "__main__":
    try:
        ...
        # Target the isolated Today's Snippet data folder
        output_file = 'data/today_snippet/tactical_events_24h.json'
