            ...
            try:
                ...
                for attempt, api_key in enumerate(api_keys):
                    try:
                        ...
                        # 🛑 FIX 3: Use blocking generation instead of stream
...
def render_fab_chat(api_keys, model_name, text_summary="", text_section_1="", text_section_2="", text_section_3="", text_section_4="", text_military="", text_india="", text_wa="", text_ews=""):
    ...
    def render_isolated_fab():
        ...
        # 2. RESTORED EXACT OLD NATIVE CSS WITH WHITE TEXT FIX
        st.markdown("""
        <style>
        ...
        /* CHAT WINDOW (RESTORED TRANSLUCENT LOOK) */
        div[data-testid="stElementContainer"]:has(#chat-anchor) + div {
            ...
            width: 380px !important; height: 550px !important; 
            background: rgba(10, 14, 20, 0.90) !important; /* Beautiful Translucent Dark Base */
            backdrop-filter: blur(12px) !important;
            -webkit-backdrop-filter: blur(12px) !important;
            border: 1px solid #333 !important; border-radius: 16px !important; z-index: 999998 !important;
        ...
        /* Response (Assistant) - Gradient Sky Blue */
        ...
        if st.session_state.fab_open:
            ...
            # 🛑 FIX: EVERYTHING must be indented INSIDE this container so it renders inside the floating window!
            with st.container():
                ...
                if not api_keys:
                    ...
                    if st.session_state.get("fab_pending_query"):
                        ...
                        with st.chat_message("assistant"):
                            ...
                            3. DO NOT use standard bracketed footnote numbers. Use explicit inline text citations based on the context provided.
                ...
                # 🛑 FIX: Match the state key exactly to the old functioning code to clear the duplicate key crash
                if "fab_input_text" not in st.session_state:
                    st.session_state.fab_input_text = ""
                
                def submit_fab_chat():
                    if st.session_state.fab_input_text.strip():
